...
// necessary classes
require_once('class.mymysoapclient.php');
...
/**
*
* [nu]mysoapclient higher level class for easy usage.
*
* usage:
*
* // instantiate client with server info
* $mysoapclient = new nusoap_client( string path [ ,mixed wsdl] );
*
* // call method, get results
* echo $mysoapclient->call( string methodname [ ,array parameters] );
*
* // bye bye client
* unset($mysoapclient);
*
...
//if (!extension_loaded('soap')) {
	/**
	 *	For backwards compatiblity, define mysoapclient unless the PHP SOAP extension is loaded.
	 */
	class mysoapclient extends nusoap_client {
	}
//}
?>
